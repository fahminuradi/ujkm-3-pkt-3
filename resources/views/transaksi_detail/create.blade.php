        ...
        <div class="card-body">
            <div class="box-body">
                <form class="form-horizontal" method="post"
                    action="{{ route('transaksi_detail.store') }}">
                    @csrf
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="number" class="form-control" name="jumlah_paket">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="{{ $transaksi_detail->subtotal }}">
                            </div>
                        </div>
                    </div>
                    <div class="col sm 6">
