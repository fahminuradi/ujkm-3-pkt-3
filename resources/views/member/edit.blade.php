...
<div class="col-xl-12 col-lg-2 ">
  <div class="card shadow mb-12 border-left-secondary">
        <div class="card-body">
            <div class="box-body">
            <form class="form-horizontal" method="post" action="{{ route('member.update',$member->id) }}"
             enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <label for="Nama outlet" class="col-sm-2 control-label">Nama Member</label>
                  <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label for="Alamat" class="col-sm-2 control-label">Jenis kelamin</label>
                  <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input type="number" class="form-control" id="telepon" name="telepon" value="{{ $member->telepon}}">
                  </div>
                </div>
